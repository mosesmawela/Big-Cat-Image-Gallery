...
export const AccountManagement: React.FC<AccountManagementProps> = ({ user, onLogout, onUpdateUser, onBack, wallpapers, onDownload, onNavigate }) => {
  ...
  const handleAddWallpaper = async () => {
    ...
    try {
      ...
      fetchWallpapers();
      toast.success('Gallery Updated', { description: 'New wallpaper added to the collection.' });
    } catch (error: any) {
      try {
  ...
  const confirmDeleteWallpaper = async () => {
    ...
    try {
      ...
      fetchWallpapers();
      toast.success('Gallery Purged', { description: 'Wallpaper removed from the collection.' });
    } catch (error: any) {
      try {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 lg:gap-24">
        ...
        <div className="space-y-12">
          <div className="flex items-center gap-6 mb-16 p-6 bg-white/5 border border-white/5 rounded-[32px] backdrop-blur-3xl">
            ...
            <div>
              <h2 className="text-xl font-black tracking-tighter italic uppercase leading-none mb-2">{user?.displayName || 'Guest User'}</h2>
              <p className="text-[10px] uppercase tracking-widest opacity-40 font-bold">{user?.isPro ? 'Pro Member' : 'Free Access'}</p>
            </div>
          </div>
          ...
          <nav className="space-y-3">
            ...
            >
              ...
              <span className="text-[10px] uppercase tracking-[0.3em] font-black italic">Log Out</span>
            </button>
          </nav>
        </div>
        ...
        <div className="bg-white/[0.03] border border-white/5 rounded-[48px] p-8 md:p-16 backdrop-blur-3xl shadow-2xl relative overflow-hidden">
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
                <div className="space-y-2">
                  <h3 className="text-4xl font-black tracking-tighter italic uppercase">Profile Settings</h3>
                  <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-bold">Manage your public profile and identity</p>
                </div>
                <button 
                  onClick={async () => {
                    try {
                      ...
                      toast.success('Profile Updated', { description: 'Settings have been saved.' });
                    } catch (error: any) {
              ...
              {!user && (
                <div className="p-12 border-2 border-dashed border-white/5 rounded-[40px] flex flex-col items-center justify-center text-center gap-6">
                   <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center text-brand-peach">
                      <User size={32} />
                   </div>
                   <div className="space-y-2">
                      <h4 className="text-xl font-black italic uppercase italic">Sign In for Full Access</h4>
                      <p className="text-[10px] uppercase tracking-widest opacity-40">Create an account to save your profile and favorites.</p>
                   </div>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-4 md:col-span-2">
                  <label className="text-[10px] uppercase tracking-[0.5em] opacity-40 ml-4 font-black">Profile Image URL</label>
                  <input 
                    type="text" 
                    value={photoURL}
                ...
                <div className="space-y-4 md:col-span-2">
                  <label className="text-[10px] uppercase tracking-[0.5em] opacity-40 ml-4 font-black">Bio</label>
                  <textarea 
                    value={bio}
          ...
          {activeTab === 'favorites' && (
            ...
            >
              <div className="space-y-2">
                <h3 className="text-4xl font-black tracking-tighter italic uppercase">Your Favorites</h3>
                <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-bold">Visuals you've saved for later</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {favoriteWallpapers.length > 0 ? (
                  ...
                  <div className="md:col-span-2 py-32 text-center space-y-8 bg-white/5 border border-white/5 rounded-[40px]">
                    ...
                    <p className="text-[10px] uppercase tracking-[1em] opacity-40">Your favorites list is empty</p>
                  </div>
                )}
              </div>
            </motion.div>
          ...
          {activeTab === 'history' && (
            ...
            >
              <div className="space-y-2">
                <h3 className="text-4xl font-black tracking-tighter italic uppercase">Download History</h3>
                <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-bold">History of visuals you've downloaded</p>
              </div>
              ...
              <div className="space-y-4">
                {user.downloadHistory && user.downloadHistory.length > 0 ? (
                  ...
                  <div className="py-32 text-center space-y-8 bg-white/5 border border-white/5 rounded-[40px]">
                    ...
                    <p className="text-[10px] uppercase tracking-[1em] opacity-40">No downloads recorded</p>
                  </div>
                )}
              </div>
            </motion.div>
          ...
          {activeTab === 'billing' && (
            ...
            >
              <div className="space-y-2">
                <h3 className="text-4xl font-black tracking-tighter italic uppercase">Subscription</h3>
                <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-bold">Manage your access to premium content</p>
              </div>
                ...
                <div>
                  ...
                  {user?.isPro && (
                    <div className="flex items-center gap-3 mt-6 opacity-40">
                      ...
                      <p className="text-[10px] uppercase tracking-[0.2em] font-bold">Status: Active</p>
                    </div>
                  )}
                </div>
                {!user.isPro ? (
                  ...
                  <button 
                    ...
                    className="px-10 py-5 border border-black/10 rounded-full text-[10px] uppercase tracking-widest font-black italic hover:bg-black/5 transition-all"
                  >
                    Cancel Access
                  </button>
                )}
          ...
          {activeTab === 'security' && (
            ...
            >
              <div className="space-y-2">
                <h3 className="text-4xl font-black tracking-tighter italic uppercase">Security</h3>
                <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-bold">Protect your account and data</p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-10">
                <div className="p-10 bg-white/5 border border-white/10 rounded-[40px] space-y-8">
                  <div className="flex items-center gap-4">
                     ...
                     <h4 className="text-xl font-black italic uppercase tracking-tighter">Change Password</h4>
                  </div>
                  <div className="space-y-6">
                    <div className="space-y-3">
                       <label htmlFor="newPassword" className="text-[8px] uppercase tracking-widest opacity-30 ml-4 font-black">New Password</label>
                       <input 
                         type="password" 
                         placeholder="••••••••••••"
                         value={newPassword}
                ...
                <div className="p-10 bg-white/5 border border-white/10 rounded-[40px] flex items-center justify-between group hover:bg-white/10 transition-all">
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] uppercase tracking-widest opacity-40 font-bold">Two-layer identity verification</p>
                  </div>
                  <button 
                    title="Initialize Two-Factor Auth"
                    aria-label="Initialize Two-Factor Auth"
          ...
          {activeTab === 'settings' && (
            ...
            >
              <div className="space-y-2">
                <h3 className="text-4xl font-black tracking-tighter italic uppercase">Preferences</h3>
                <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-bold">Optimize the site experience</p>
              </div>

              <div className="grid grid-cols-1 gap-6">
                {[
                  { id: 'showExplicit', label: 'Explicit Content', desc: 'Allow uncensored visual data' },
                  { id: 'emailNotifications', label: 'Newsletter', desc: 'Receive updates from the studio' },
                  { id: 'publicProfile', label: 'Public Profile', desc: 'Show your favorites to others' },
                  { id: 'dataUsage', label: 'Data Saving', desc: 'Optimize load times for lower bandwidth' },
                ].map((s) => (
                  <div key={s.id} className="p-10 bg-white/5 border border-white/10 rounded-[40px] flex items-center justify-between group hover:bg-white/10 transition-all">
                    ...
                    <button 
                      onClick={() => {
                        ...
                        toast.success(`${s.label} Adjusted`, { description: `Preference is now ${val ? 'active' : 'inactive'}.` });
                      }}
          ...
          {activeTab === 'admin' && user?.role === 'admin' && (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
                <div className="space-y-2">
                  <h3 className="text-4xl font-black tracking-tighter italic uppercase">Admin Control</h3>
                  <p className="text-[10px] uppercase tracking-[0.5em] opacity-40 font-bold">Global Gallery Management</p>
                </div>
              </div>

              {/* Add New Wallpaper */}
              <div className="bg-white/5 border border-white/10 rounded-[40px] p-12 space-y-10">
                <h4 className="text-xl font-black italic uppercase tracking-tighter">Add New Wallpaper</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-[8px] uppercase tracking-widest opacity-30 ml-4 font-black">Title</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-3">
                    <label className="text-[8px] uppercase tracking-widest opacity-30 ml-4 font-black">URL</label>
                    <input 
                      type="text" 
                      placeholder="HTTPS://..."
                  ...
                  <div className="space-y-3">
                    <label className="text-[8px] uppercase tracking-widest opacity-30 ml-4 font-black">Category</label>
                    <select 
                  ...
                  <div className="flex items-center gap-12 px-8 pt-6">
                    <label className="flex items-center gap-4 cursor-pointer group">
                      ...
                      <input 
                        ...
                        className="hidden"
                      />
                      <span className="text-[10px] uppercase tracking-widest font-black italic">Pro Plan</span>
                    </label>
                    <label className="flex items-center gap-4 cursor-pointer group">
                      ...
                      <input 
                        ...
                        className="hidden"
                      />
                      <span className="text-[10px] uppercase tracking-widest font-black italic">Live Wallpaper</span>
                    </label>
                  </div>
                </div>
                <button 
                ...
                >
                  {isAdminLoading ? 'ADDING...' : 'ADD TO GALLERY'}
                </button>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center justify-between ml-4">
                  <h4 className="text-xl font-black italic uppercase tracking-tighter">Active Wallpapers ({adminWallpapers.length})</h4>
                </div>
                <div className="grid grid-cols-1 gap-4">
                  {adminWallpapers.length > 0 ? (
                    ...
                    <div className="py-24 text-center bg-white/5 border border-white/5 rounded-[40px]">
                      <p className="text-[10px] uppercase tracking-[1em] opacity-40">Gallery is empty</p>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-[1000] bg-black/90 backdrop-blur-2xl flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="text-center space-y-4">
              <h3 className="text-3xl font-black italic uppercase tracking-tighter">Delete Wallpaper?</h3>
              <p className="text-sm opacity-60 font-medium">This action will permanently delete this wallpaper from the gallery. This cannot be reversed.</p>
            </div>
